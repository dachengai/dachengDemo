 ...
 */
public class CircularProgress extends Drawable {
    /**
     ...
     */
    CircularProgress(int ringWidth, float circleScale, int outlineColor, int ringColor, int centerColor) {
        this.progress = 0;
    ...
    /**
     * Helper class to manage the creation of a CircularProgress
     *
    ...
    public static class Builder {
        ...
        /**
         * Creates a new CircularProgress with the requested parameters
         *
         * @return New CircularProgressInstance
         */
        public CircularProgress create() {
            return new CircularProgress(ringWidth, circleScale, outlineColor, ringColor, centerColor);
        }
