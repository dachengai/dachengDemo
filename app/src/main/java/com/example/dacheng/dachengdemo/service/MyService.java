...
public class MyService extends Service{
    ...
    public IBinder onBind(Intent intent) {
        Log.e(DemoConst.LogTag, "MyService-----onBind");
    ...
    public boolean onUnbind(Intent intent) {
        Log.e(DemoConst.LogTag, "MyService-----onUnbind");
    ...
    public void onCreate() {
        super.onCreate();
        Log.e(DemoConst.LogTag, "MyService-----onCreate");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.e(DemoConst.LogTag, "MyService-----onStartCommand");
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.e(DemoConst.LogTag, "MyService-----onDestroy");
        running = false;
    }
