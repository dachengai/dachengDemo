package com.example.dacheng.dachengdemo.imageloader;
...
import com.example.dacheng.dachengdemo.imageloader.cache.DiskLruCache;
...
public class FreeImageLoader {
    ...
    private static final int IMG_URL = 123;
